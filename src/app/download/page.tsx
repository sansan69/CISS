  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#06243E] to-[#014c85] px-4">
      <div className="max-w-md w-full text-center">
        ...
        {/* Download Button */}
        <a
          href="https://firebasestorage.googleapis.com/v0/b/ciss-workforce.firebasestorage.app/o/releases%2Fciss-workforce.apk?alt=media"
        ...
        <p className="text-xs text-white/40 mt-4">
          Version 1.0.0 · 74 MB · Android 7.0+
        </p>
