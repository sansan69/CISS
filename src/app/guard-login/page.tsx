...
export default function GuardLoginPage() {
  ...
  return (
    ...
    >
      {/* Inner wrapper — stacks on mobile, centered card on desktop */}
      <div className="flex-1 flex flex-col w-full md:flex-none md:w-full md:max-w-sm md:mx-auto">

        {/* Brand header */}
        <div className="flex flex-col items-center justify-center pt-16 pb-8 px-6 md:pt-10 md:pb-6 animate-slide-up">
          <div
        ...
        {/* Card — floats from bottom on mobile, rounded card on desktop */}
        <div className="flex-1 flex flex-col md:flex-none animate-slide-up stagger-2">
          <Card
            className="flex-1 md:flex-none rounded-t-3xl rounded-b-none md:rounded-2xl border-0 md:border md:border-white/15 shadow-none md:shadow-[0_24px_60px_rgba(0,0,0,0.4)]"
