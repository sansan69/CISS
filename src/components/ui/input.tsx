  ...
  ({ className, type, startIcon, endIcon, ...props }, ref) => {
      ...
      return (
        <div className="relative flex items-center w-full">
          ...
          <input
            ...
            className={cn(
              // Base
              "flex w-full rounded-xl border border-input bg-card",
              "text-sm text-foreground placeholder:text-muted-foreground",
              "ring-offset-background",
              // Sizing — 44px height on mobile, 40px on desktop (both ≥ touch target)
              "h-11 md:h-10 py-2",
              // Focus ring — brand blue
              "focus-visible:border-primary/70 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/10",
              // File inputs
    ...
    return (
      <input
        type={type}
        className={cn(
          "flex h-11 w-full rounded-xl border border-input bg-card px-3 py-2 md:h-10",
          "text-sm text-foreground placeholder:text-muted-foreground",
          "ring-offset-background",
          "focus-visible:border-primary/70 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/10",
          "file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground",
